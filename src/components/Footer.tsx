export default function Footer() {
  return (
    <footer className="border-t-4 border-slate-700 p-4 mt-4">
      <nav className="flex justify-start gap-6 flex-wrap overflow-x-auto scrollbar-thin scrollbar-thumb-slate-500 scrollbar-track-slate-300 dark:scrollbar-thumb-slate-500 dark:scrollbar-track-slate-700">
