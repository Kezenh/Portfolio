...
export default function Header() {
  ...
  return (
    <header className="border-b-4 border-slate-700 p-4 sticky top-0 z-50 bg-slate-300 dark:bg-slate-950 flex w-full justify-between items-center flex-wrap gap-4">
